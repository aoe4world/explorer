      ...
      changes: [
        {
          ...
          civs: [],
          diff: [
            ["fix", "Fixed a bug where units would ignore commands given to them when using shift. This happened when the physical distance between locations was very close."],
            ["fix","Fixed a bug where the player could not shift queue attack moves without multiple presses of the “A” key."],
            ["fix","You can now queue up building as many structures as you can afford. Previously the placement of the last building(s) would be cancelled due to available resource miscalculation."]
          ],
        },
      ],
    },
...
export const patches = [s1, s1ServerSide1, patch14681, serverSidePatch14681, patch15965];
