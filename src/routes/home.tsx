        ...
        <div class="mx-2 sm:mx-6">
          <div class="flex flex-wrap items-center">
            ...
            <Link
              ...
              ref={el}
            >
              <i class="fas fa-asterisk mr-1"></i> Patch 13.0.4157 (Preview)
            </Link>
            <Tooltip attachTo={el}>
              <div class={tooltipCSSClass}>The Explorer includes all changes introduced with Season 10 Patch 13.0.4157</div>
            </Tooltip>
          </div>
