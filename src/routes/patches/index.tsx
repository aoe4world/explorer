              ...
              <div class="flex flex-auto flex-col lg:flex-row py-3 gap-2 lg:items-center">
                ...
                <div class="basis-2/3 shrink-0">
                  ...
                  <div class="max-w-2xl h-2 w-[300px] flex rounded-full overflow-hidden">
                    <div class="bg-green-500 flex-shrink" style={{ "flex-basis": patch.buffed * 1.5 + "px" }} />
                    <div class="bg-red-500 flex-shrink" style={{ "flex-basis": patch.nerfed * 1.5 + "px" }} />
                    <div class="bg-gray-200 flex-shrink" style={{ "flex-basis": patch.changes * 1.5 + "px" }} />
                    <div class="bg-white/20 flex-shrink" style={{ "flex-basis": patch.fixed * 1.5 + "px" }} />
                  </div>
                </div>
              </div>
